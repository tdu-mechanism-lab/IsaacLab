...
UNITREE_A1_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ".*L_hip_joint": 0.1,
            ".*R_hip_joint": -0.1,
            "F[L,R]_thigh_joint": 0.423599,
            "R[L,R]_thigh_joint": -0.361799,
            "F[L,R]_calf_joint": -0.847200,
            "R[L,R]_calf_joint": 0.859931,
            "F[L,R]_calf2_joint": 0.67266,
            "R[L,R]_calf2_joint": -0.721730,
        },
        joint_vel={".*": 0.0},
    ),
    ...
    actuators={
        "base_legs": DCMotorCfg(
            joint_names_expr=[".*_hip_joint", ".*_thigh_joint", ".*_calf_joint", ".*_calf2_joint"],
            effort_limit=33.5,
